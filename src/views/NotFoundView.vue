<template>
  <main class="h-full">
    <div class="absolute top-0 left-0 h-screen w-full bg-green-200 -z-20"></div>
    <div
      class="flex flex-col items-center h-full mt-[70px] bg-[url('@/assets/rivoli-gallery.jpg')] bg-no-repeat bg-top bg-contain bg-opacity-30"
    >
